...
const Mensaje listaErrores[] = {
    ...
    {POLINOMIO_NO_EXISTENTE1, "El nombre del Polinomio del segundo parametro debe ser alfanumerico.\n"},
    {POLINOMIO_NO_EXISTENTE2, "El nombre del Polinomio del tercer parametro debe ser alfanumerico.\n"},
